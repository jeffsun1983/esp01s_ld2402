...
LD2402Component = ld2402_ns.class_("LD2402Component")
LD2402Number = ld2402_ns.class_("LD2402Number", number.Number, cg.Component)
...
BASE_SCHEMA = {
    cv.GenerateID(): cv.declare_id(LD2402Number),
...
async def to_code(config):
    ...
    parent = await cg.get_variable(config[CONF_LD2402_ID])
